...
\begin{frame}{Generating a Bib\TeX{} database}
	\begin{itemize}
		...
		\item Many journals have a download Bib\TeX{} citation option on their website - you can either import this into your reference manager or paste it into your \textbf{.bib} file directly
	\end{itemize}
\end{frame}
...
\begin{frame} \frametitle{Resources}
	\begin{itemize}
		\item \href{http://www.github.com/gcapes/thesis-latex-manc-coursematerials}{The Course Resources}
