...
\begin{frame}[fragile]{Floats}
	\begin{itemize}
		...
		\item To display images, use the \lstinline|\includegraphics{file}| command from the \texttt{graphicx} package, which needs to be in your \hyperlink{sl:structure}{preamble}
