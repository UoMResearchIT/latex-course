...
\begin{frame}{Output files}{I only wanted a pdf!}
	...
	\end{itemize}
	If your .tex file contains cross-references and citations, it will need to be processed several times to resolve the dependencies between the intermediate files. The typical sequence is: \href{http://www.tex.ac.uk/FAQ-usebibtex.html}{latex~bibtex~latex~latex}.
\end{frame}
