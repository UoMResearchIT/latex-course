...
\begin{frame}[fragile] \frametitle{Some terminology}
	\begin{itemize}
		...
		\item TeXstudio is an IDE (i.e. a convenient way to prepare your source files, and compile them using \LaTeX{})
	\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Floats}
	\begin{itemize}
		...
		\item To display images, use the \lstinline|\includegraphics{file}| command from the \texttt{graphicx} package
