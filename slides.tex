...
\begin{frame}{A few tasters}{(Previews rather than worked examples)}
	\begin{itemize}
		\item \href{https://github.com/UoMResearchIT/MATLAB-online-exercises/tree/master/lesson5_programming}{Typeset code in external code files}
		\item \href{https://www.sharelatex.com/templates/cv-or-resume}{CV template}
		\item Hyperlinks in text
		\item Section bookmarks in pdf
	\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Input files}{How to typeset mathematical equations}
	...
	\begin{enumerate}
		...
		\end{equation}
	\end{enumerate}
	Have a look in the side panel and Math menu.\\
...
\begin{frame}[fragile]{Author-Year citations}{Using the natbib package and Bib\TeX{} program}
	\begin{itemize}
		...
		\begin{itemize}
			...
			generate using e.g. \href{https://www.mendeley.com/}{Mendeley}
			\item \lstinline|\usepackage{natbib}| in your preamble
			\item \lstinline|\bibliography{<file>}| makes your bibliography.
			Note that the \textbf{.bib} file extension is not required.
