...
To create a project file:
\begin{itemize}
\item Navigate to \texttt{File > New > Project}. Select \texttt{Empty Project}, and ensure you select the correct project path, enable BibTeX and MakeIndex and give your project a name. Click OK.
\item Navigate to \texttt{Project > Properties} and select the correct main file (probably \texttt{thesis.tex}). Make any other changes to settings (like languages) and click OK. 
\item Close TexnicCenter and re-open the newly created project file (\texttt{*.prj}).
\end{itemize}
