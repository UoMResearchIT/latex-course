...
The current version of the University Thesis Document can be downloaded from the Github repository, \url{https://github.com/tombishop1/thesis-latex-manc/}, using the \texttt{Clone or download} option. Ensure you have the correct branch selected --- this version of the course requires the \texttt{biber} branch selected.
